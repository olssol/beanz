...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'sr', line 22, column 1 to column 15)",
                                                      " (in 'sr', line 23, column 1 to column 19)",
                                                      " (in 'sr', line 24, column 2 to column 37)",
                                                      " (in 'sr', line 25, column 1 to column 18)",
                                                      " (in 'sr', line 28, column 1 to column 26)",
                                                      " (in 'sr', line 29, column 1 to column 17)",
                                                      " (in 'sr', line 33, column 4 to column 44)",
                                                      " (in 'sr', line 32, column 9 to line 34, column 3)",
                                                      " (in 'sr', line 31, column 4 to column 48)",
                                                      " (in 'sr', line 30, column 21 to line 32, column 3)",
                                                      " (in 'sr', line 30, column 2 to line 34, column 3)",
                                                      " (in 'sr', line 35, column 2 to column 19)",
                                                      " (in 'sr', line 45, column 2 to column 23)",
                                                      " (in 'sr', line 47, column 4 to column 50)",
                                                      " (in 'sr', line 46, column 20 to line 48, column 3)",
                                                      " (in 'sr', line 46, column 2 to line 48, column 3)",
                                                      " (in 'sr', line 38, column 1 to column 30)",
                                                      " (in 'sr', line 39, column 1 to column 29)",
                                                      " (in 'sr', line 40, column 1 to column 23)",
                                                      " (in 'sr', line 41, column 2 to column 23)",
                                                      " (in 'sr', line 42, column 1 to column 25)",
                                                      " (in 'sr', line 10, column 1 to column 20)",
                                                      " (in 'sr', line 11, column 1 to column 18)",
                                                      " (in 'sr', line 12, column 8 to column 12)",
                                                      " (in 'sr', line 12, column 1 to column 17)",
                                                      " (in 'sr', line 13, column 8 to column 12)",
                                                      " (in 'sr', line 13, column 1 to column 20)",
                                                      " (in 'sr', line 14, column 8 to column 12)",
                                                      " (in 'sr', line 14, column 14 to column 16)",
                                                      " (in 'sr', line 14, column 1 to column 20)",
                                                      " (in 'sr', line 15, column 2 to column 18)",
                                                      " (in 'sr', line 16, column 1 to column 21)",
                                                      " (in 'sr', line 17, column 2 to column 33)",
                                                      " (in 'sr', line 18, column 2 to column 18)",
                                                      " (in 'sr', line 19, column 2 to column 19)",
                                                      " (in 'sr', line 23, column 8 to column 10)",
                                                      " (in 'sr', line 24, column 27 to column 31)",
                                                      " (in 'sr', line 25, column 8 to column 12)",
                                                      " (in 'sr', line 28, column 17 to column 21)",
                                                      " (in 'sr', line 29, column 8 to column 12)",
                                                      " (in 'sr', line 45, column 9 to column 13)"};
#include <stan_meta_header.hpp>
class model_sr final : public model_base_crtp<model_sr> {
private:
  int SIZE;
  int NX;
...
public:
  ...
  inline std::string model_name() const final { return "model_sr"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_sr(stan::io::var_context& context__, unsigned int random_seed__ = 0,
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_sr_namespace::log_prob";
(void) function__;  // suppress unused var warning
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"b0\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"bgamma\",\"type\":{\"name\":\"vector\",\"length\":" << NX << "},\"block\":\"parameters\"},{\"name\":\"uvs\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"parameters\"},{\"name\":\"nvs\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"parameters\"},{\"name\":\"vs\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"transformed_parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_sr_namespace::model_sr;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_sr_namespace::profiles__;
}
#endif
#endif
