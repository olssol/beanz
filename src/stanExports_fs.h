...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'fs', line 18, column 1 to column 17)",
                                                      " (in 'fs', line 19, column 1 to column 36)",
                                                      " (in 'fs', line 20, column 1 to column 18)",
                                                      " (in 'fs', line 23, column 1 to column 26)",
                                                      " (in 'fs', line 27, column 4 to column 44)",
                                                      " (in 'fs', line 26, column 9 to line 28, column 3)",
                                                      " (in 'fs', line 25, column 4 to column 48)",
                                                      " (in 'fs', line 24, column 21 to line 26, column 3)",
                                                      " (in 'fs', line 24, column 2 to line 28, column 3)",
                                                      " (in 'fs', line 37, column 2 to column 23)",
                                                      " (in 'fs', line 39, column 4 to column 50)",
                                                      " (in 'fs', line 38, column 20 to line 40, column 3)",
                                                      " (in 'fs', line 38, column 2 to line 40, column 3)",
                                                      " (in 'fs', line 31, column 1 to column 27)",
                                                      " (in 'fs', line 32, column 2 to column 21)",
                                                      " (in 'fs', line 33, column 2 to column 20)",
                                                      " (in 'fs', line 34, column 2 to column 23)",
                                                      " (in 'fs', line 9, column 1 to column 20)",
                                                      " (in 'fs', line 10, column 8 to column 12)",
                                                      " (in 'fs', line 10, column 1 to column 17)",
                                                      " (in 'fs', line 11, column 8 to column 12)",
                                                      " (in 'fs', line 11, column 1 to column 20)",
                                                      " (in 'fs', line 12, column 1 to column 21)",
                                                      " (in 'fs', line 13, column 2 to column 33)",
                                                      " (in 'fs', line 14, column 2 to column 18)",
                                                      " (in 'fs', line 15, column 2 to column 19)",
                                                      " (in 'fs', line 18, column 8 to column 12)",
                                                      " (in 'fs', line 19, column 26 to column 30)",
                                                      " (in 'fs', line 20, column 8 to column 12)",
                                                      " (in 'fs', line 23, column 17 to column 21)",
                                                      " (in 'fs', line 37, column 9 to column 13)"};
#include <stan_meta_header.hpp>
class model_fs final : public model_base_crtp<model_fs> {
private:
  int SIZE;
...
public:
  ...
  inline std::string model_name() const final { return "model_fs"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_fs(stan::io::var_context& context__, unsigned int random_seed__ = 0,
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_fs_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      }
      {
        ...
        lp_accum__.add(normal_lpdf<propto__>(mu, MU, stan::math::sqrt(B)));
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"parameters\"},{\"name\":\"uvs\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"parameters\"},{\"name\":\"nvs\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"parameters\"},{\"name\":\"vs\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_fs_namespace::model_fs;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_fs_namespace::profiles__;
}
#endif
#endif
