...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(82, 80, "end", "model_eds");
    return reader;
}
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  bgamma(static_cast<Eigen::VectorXd::Index>(NX));
