...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'ds', line 23, column 2 to column 10)",
                                                      " (in 'ds', line 24, column 2 to column 22)",
                                                      " (in 'ds', line 25, column 2 to column 37)",
                                                      " (in 'ds', line 26, column 1 to column 18)",
                                                      " (in 'ds', line 27, column 2 to column 20)",
                                                      " (in 'ds', line 30, column 1 to column 26)",
                                                      " (in 'ds', line 31, column 2 to column 20)",
                                                      " (in 'ds', line 32, column 1 to column 17)",
                                                      " (in 'ds', line 36, column 4 to column 44)",
                                                      " (in 'ds', line 35, column 9 to line 37, column 3)",
                                                      " (in 'ds', line 34, column 4 to column 48)",
                                                      " (in 'ds', line 33, column 21 to line 35, column 3)",
                                                      " (in 'ds', line 33, column 2 to line 37, column 3)",
                                                      " (in 'ds', line 38, column 2 to column 26)",
                                                      " (in 'ds', line 39, column 2 to column 23)",
                                                      " (in 'ds', line 56, column 2 to column 23)",
                                                      " (in 'ds', line 58, column 4 to column 50)",
                                                      " (in 'ds', line 57, column 20 to line 59, column 3)",
                                                      " (in 'ds', line 57, column 2 to line 59, column 3)",
                                                      " (in 'ds', line 42, column 2 to column 31)",
                                                      " (in 'ds', line 43, column 2 to column 23)",
                                                      " (in 'ds', line 44, column 2 to column 24)",
                                                      " (in 'ds', line 45, column 2 to column 23)",
                                                      " (in 'ds', line 51, column 4 to column 31)",
                                                      " (in 'ds', line 49, column 9 to line 52, column 3)",
                                                      " (in 'ds', line 48, column 4 to column 26)",
                                                      " (in 'ds', line 46, column 14 to line 49, column 3)",
                                                      " (in 'ds', line 46, column 2 to line 52, column 3)",
                                                      " (in 'ds', line 53, column 2 to column 21)",
                                                      " (in 'ds', line 11, column 2 to column 24)",
                                                      " (in 'ds', line 12, column 1 to column 21)",
                                                      " (in 'ds', line 13, column 8 to column 12)",
                                                      " (in 'ds', line 13, column 1 to column 20)",
                                                      " (in 'ds', line 14, column 8 to column 12)",
                                                      " (in 'ds', line 14, column 1 to column 23)",
                                                      " (in 'ds', line 15, column 8 to column 12)",
                                                      " (in 'ds', line 15, column 14 to column 16)",
                                                      " (in 'ds', line 15, column 1 to column 20)",
                                                      " (in 'ds', line 16, column 1 to column 17)",
                                                      " (in 'ds', line 17, column 1 to column 21)",
                                                      " (in 'ds', line 18, column 2 to column 33)",
                                                      " (in 'ds', line 19, column 2 to column 18)",
                                                      " (in 'ds', line 20, column 2 to column 19)",
                                                      " (in 'ds', line 25, column 27 to column 31)",
                                                      " (in 'ds', line 26, column 8 to column 12)",
                                                      " (in 'ds', line 27, column 9 to column 11)",
                                                      " (in 'ds', line 30, column 17 to column 21)",
                                                      " (in 'ds', line 31, column 9 to column 11)",
                                                      " (in 'ds', line 32, column 8 to column 12)",
                                                      " (in 'ds', line 56, column 9 to column 13)"};
#include <stan_meta_header.hpp>
class model_ds final : public model_base_crtp<model_ds> {
private:
  int SIZE;
  int NX;
...
public:
  ...
  inline std::string model_name() const final { return "model_ds"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_ds(stan::io::var_context& context__, unsigned int random_seed__ = 0,
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_ds_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      assign(bgamma, nil_index_list(), multiply(nomega, omega),
...
using stan_model = model_ds_namespace::model_ds;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_ds_namespace::profiles__;
}
#endif
#endif
