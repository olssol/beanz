...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'srs', line 24, column 2 to column 22)",
                                                      " (in 'srs', line 25, column 2 to column 10)",
                                                      " (in 'srs', line 26, column 2 to column 20)",
                                                      " (in 'srs', line 27, column 2 to column 37)",
                                                      " (in 'srs', line 28, column 1 to column 18)",
                                                      " (in 'srs', line 29, column 2 to column 20)",
                                                      " (in 'srs', line 32, column 1 to column 26)",
                                                      " (in 'srs', line 33, column 1 to column 17)",
                                                      " (in 'srs', line 34, column 2 to column 19)",
                                                      " (in 'srs', line 38, column 4 to column 44)",
                                                      " (in 'srs', line 37, column 9 to line 39, column 3)",
                                                      " (in 'srs', line 36, column 4 to column 48)",
                                                      " (in 'srs', line 35, column 21 to line 37, column 3)",
                                                      " (in 'srs', line 35, column 2 to line 39, column 3)",
                                                      " (in 'srs', line 40, column 2 to column 21)",
                                                      " (in 'srs', line 41, column 2 to column 30)",
                                                      " (in 'srs', line 60, column 2 to column 23)",
                                                      " (in 'srs', line 62, column 4 to column 50)",
                                                      " (in 'srs', line 61, column 20 to line 63, column 3)",
                                                      " (in 'srs', line 61, column 2 to line 63, column 3)",
                                                      " (in 'srs', line 44, column 2 to column 32)",
                                                      " (in 'srs', line 45, column 2 to column 31)",
                                                      " (in 'srs', line 46, column 2 to column 24)",
                                                      " (in 'srs', line 47, column 2 to column 25)",
                                                      " (in 'srs', line 48, column 2 to column 24)",
                                                      " (in 'srs', line 55, column 4 to column 31)",
                                                      " (in 'srs', line 53, column 9 to line 56, column 3)",
                                                      " (in 'srs', line 52, column 4 to column 26)",
                                                      " (in 'srs', line 50, column 14 to line 53, column 3)",
                                                      " (in 'srs', line 50, column 2 to line 56, column 3)",
                                                      " (in 'srs', line 57, column 2 to column 21)",
                                                      " (in 'srs', line 11, column 2 to column 24)",
                                                      " (in 'srs', line 12, column 1 to column 21)",
                                                      " (in 'srs', line 13, column 8 to column 12)",
                                                      " (in 'srs', line 13, column 1 to column 20)",
                                                      " (in 'srs', line 14, column 8 to column 12)",
                                                      " (in 'srs', line 14, column 1 to column 23)",
                                                      " (in 'srs', line 15, column 8 to column 12)",
                                                      " (in 'srs', line 15, column 14 to column 16)",
                                                      " (in 'srs', line 15, column 1 to column 20)",
                                                      " (in 'srs', line 16, column 2 to column 18)",
                                                      " (in 'srs', line 17, column 1 to column 17)",
                                                      " (in 'srs', line 18, column 1 to column 21)",
                                                      " (in 'srs', line 19, column 2 to column 33)",
                                                      " (in 'srs', line 20, column 2 to column 18)",
                                                      " (in 'srs', line 21, column 2 to column 19)",
                                                      " (in 'srs', line 26, column 9 to column 11)",
                                                      " (in 'srs', line 27, column 27 to column 31)",
                                                      " (in 'srs', line 28, column 8 to column 12)",
                                                      " (in 'srs', line 29, column 9 to column 13)",
                                                      " (in 'srs', line 32, column 17 to column 21)",
                                                      " (in 'srs', line 33, column 8 to column 12)",
                                                      " (in 'srs', line 34, column 9 to column 13)",
                                                      " (in 'srs', line 60, column 9 to column 13)"};
#include <stan_meta_header.hpp>
class model_srs final : public model_base_crtp<model_srs> {
private:
  int SIZE;
  int NX;
...
public:
  ...
  inline std::string model_name() const final { return "model_srs"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_srs(stan::io::var_context& context__, unsigned int random_seed__ = 0,
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_srs_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      assign(mu, nil_index_list(), add(add(b0, multiply(X, bgamma)), phi),
      ...
      }
      {
        ...
        lp_accum__.add(normal_lpdf<propto__>(bgamma, 0, stan::math::sqrt(C)));
...
(void) function__;  // suppress unused var warning
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      {
        std::vector<local_scalar_t__> bgamma_flat__;
        current_statement__ = 3;
        assign(bgamma_flat__, nil_index_list(), context__.vals_r("bgamma"),
          "assigning variable bgamma_flat__");
        current_statement__ = 3;
        pos__ = 1;
        current_statement__ = 3;
        for (int sym1__ = 1; sym1__ <= NX; ++sym1__) {
          current_statement__ = 3;
          assign(bgamma, cons_list(index_uni(sym1__), nil_index_list()),
            bgamma_flat__[(pos__ - 1)], "assigning variable bgamma");
          current_statement__ = 3;
          pos__ = (pos__ + 1);}
      }
      Eigen::Matrix<double, -1, 1> uvs;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"omega\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"b0\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"bgamma\",\"type\":{\"name\":\"vector\",\"length\":" << NX << "},\"block\":\"parameters\"},{\"name\":\"uvs\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"parameters\"},{\"name\":\"nvs\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"parameters\"},{\"name\":\"nphi\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"parameters\"},{\"name\":\"vs\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"transformed_parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"transformed_parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" << SIZE << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_srs_namespace::model_srs;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_srs_namespace::profiles__;
}
#endif
#endif
